...
//                    FirebaseUser usuarioFirebase = task.getResult().getUser();
                    ...
                    try{
                        ...
                        erroExcecao = "Esse usuário já existe no app. Por favor, tente novamente";
                    } catch (Exception e){
                        erroExcecao = "Erro ao cadastrar usuário";
                        e.printStackTrace();
                    }

                    Toast.makeText(CadastroUsuarioActivity.this, "Não foi possível cadastrar usuário: " + erroExcecao, Toast.LENGTH_LONG).show();
                }
            }
        });
